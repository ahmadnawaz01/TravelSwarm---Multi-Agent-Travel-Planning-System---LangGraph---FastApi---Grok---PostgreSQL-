...
function copyResult() {
    ...
    navigator.clipboard.writeText(text)
        .then(() => {
            const copyBtnText = document.querySelector(".copy-btn .action-btn-text");
            const oldText = copyBtnText ? copyBtnText.textContent : "Copy";
...
function downloadPDF() {
    ...
    const downloadBtnText = document.querySelector(".download-btn .action-btn-text");
